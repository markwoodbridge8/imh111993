import appTellerManager, {DaffiTeller} from "../network/teller/appTellerManager";
import DaffiWalletConnectError from "../DaffiWalletConnectError";
  ...
  return new Promise((resolve, reject) => {
    try {
        ...
        if (count === WAIT_FOR_TAB_MAX_TRY_COUNT) {
          ...
          reject(
            new DaffiWalletConnectError(
              ...
              "Couldn't open Daffi Wallet, please try again."
            )
          );
          return;
        }
      ...
      appTellerManager.setupListener({
        onReceiveMessage: (newTabEvent: MessageEvent<TellerMessage<DaffiTeller>>) => {
