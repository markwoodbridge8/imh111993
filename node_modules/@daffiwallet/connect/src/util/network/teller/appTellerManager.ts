import {DaffiWalletTransaction} from "../../model/daffiWalletModels";
import Teller from "./Teller";

export type DaffiTeller =
  | {
      type: "CONNECT";
      data: {
        title: string;
...
const appTellerManager = new Teller<DaffiTeller>({
